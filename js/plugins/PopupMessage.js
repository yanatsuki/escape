...
/*:
 * @plugindesc ver1.01/メッセージの表示をポップアップに変更する制御文字_pum[delay,x,y,action]を追加します。
 * @author Yana
 * 
 ...
 * 
 * メッセージの表示のメッセージの中に_pum[delay,x,y,action]と記述することで、メッセージをポップアップに変更します。
